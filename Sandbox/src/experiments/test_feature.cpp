...
TestFeature::TestFeature(Renderer& renderer)
...
void TestFeature::onRender(VkCommandBuffer cmd, VkImageView drawImageView, uint32_t frameIndex)
{
...
void TestFeature::onResize(uint32_t width, uint32_t height)
{
    m_drawExtent = {width, height};
}

RenderPassType TestFeature::getType() const
{
